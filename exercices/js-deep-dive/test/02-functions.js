...
var functionsAnswers = require('../questions/02-functions');
...
describe('functions', function () {
    ...
    it('you should be able to return a string prefixer', function () {
        ...
        expect(functionsAnswers.stringPrefixer('Hey, ')('can I have a function?')).to.equal(
            'Hey, can I have a function?'
        );
    });
    ...
    it('you should be able to create a "partial" function for variable number of applied arguments', function () {
        ...
        var b = Math.random();
        var c = Math.random();
        expect(functionsAnswers.createAddArgumentsFunction(partialMe)(a, b, c)).to.equal(
            partialMe(a, b, c)
        );
        expect(functionsAnswers.createAddArgumentsFunction(partialMe, a)(b, c)).to.equal(
            partialMe(a, b, c)
